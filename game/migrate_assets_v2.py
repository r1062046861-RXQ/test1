...
def migrate_and_update_excel():
    ...
    # 0. Basic Cards (Fixing the missing Strike/Defend)
    add_entry(current_id, "打击", "造成6点伤害。", "PlayerDeck", "Attack", "Common", 1, "基础卡"); current_id += 1
    add_entry(current_id, "防御", "获得5点护盾。", "PlayerDeck", "Skill", "Common", 1, "基础卡"); current_id += 1
